...
def set_variable_in_dict(dict_to_set, variable_name, variable_value):
    ...
    if len(token_list) == 1:
        ...
        if match is not None:
            update_list_in_dict(dict_to_set, parsed_variable_name, index_list, variable_value)
        else:
        ...
        if match is not None:
            ...
            update_list_in_dict(dict_to_set, parsed_variable_name, index_list, new_dict)
        else:
        ...
        set_variable_in_dict(new_dict, variable_name.split('.', maxsplit=1)[1], variable_value)
        ...
        for row in csvreader:
            ...
            if first_row:
                ...
                for field in field_names:
                    ...
                    if match:
                        ...
                        if typeconvert == 'int':
                            ...
                            raise NotImplementedError('Type: '+typeconvert+' is not supported.')
                ...
                for field_name in field_names:
                    ...
                    index += 1
                object_list.append(object_dict)  # append this instance to a list
    return object_list
